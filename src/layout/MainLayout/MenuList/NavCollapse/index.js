...
const NavCollapse = ({ menu, level, parentId }) => {
    ...
    const menuIcon = menu.icon ? (
        <Icon
            ...
            style={{ color: isSelected ? theme.palette.primary.light : theme.palette.text.primary }}
        />
    ) : (
    ...
    const iconSelectedColor = theme.palette.mode === 'dark' && drawerOpen ? 'text.primary' : theme.palette.primary.light;
                                ...
                                sx={{
                                    ...
                                    ...(!drawerOpen &&
                                        level === 1 && {
                                            ...
                                            '&:hover': {
                                                bgcolor: theme.palette.mode === 'dark' ? theme.palette.primary.light + 25 : 'primary.light'
                                            },
                                            ...(isSelected && {
                                                bgcolor: theme.palette.mode === 'dark' ? theme.palette.primary.light + 25 : 'primary.light',
                                                '&:hover': {
                                                    bgcolor:
                                                        theme.palette.mode === 'dark' ? theme.palette.primary.light + 30 : 'primary.light'
                                                }
                                            })
                                        })
                                }}
